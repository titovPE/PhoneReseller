...
14.1.0 теперь на странице можно напечатать несколько ценников и несколько страниц. + новый движок печати
14.0.2 передача нескольких телефонов на печать
14.0.1 ошибка печати документа при определении шрифтов
14.0.0 фреймворк 4.8

13.2.0 Отключена автоматическая печать ценника
		Исправлен рачет наценки про редактировании цены
12.10.0 Таблца сессий для работы со сверками и поле с тибом действая в таблице логирования. код вычисления и записи сессии в БД
